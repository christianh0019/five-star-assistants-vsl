...
const faqs = [
    {
        ...
        answer: 'There are zero upfront fees — no placement fees, no contracts, no per-hire charges. You only pay their hourly wage once you decide to bring someone on. Whether you hire one person or a full department, it costs nothing to get started.',
    },
    {
        question: 'Can I hire for multiple roles at the same time?',
        answer: 'Yes. We handle each placement individually so you can build out multiple roles in parallel. Many clients start with one or two hires and expand from there as their team proves itself.',
    },
    {
        question: 'What kinds of roles can I fill on my remote team?',
        answer: 'Virtual assistants, appointment setters, SDRs, social media managers, customer service reps, data entry specialists, bookkeepers, and more. We match each role with a specialist who has real experience in that function — not a generalist trying to do everything.',
    },
    {
        question: 'How quickly can I build out a team?',
        answer: 'Most clients are matched with qualified candidates within a few business days per role. Once you approve someone, they can typically start within the week. You can ramp up as fast or as slow as you want.',
    },
    {
        question: 'What if someone on my team isn\'t a good fit?',
        answer: 'Just let us know. There\'s no long-term commitment. We\'ll replace them at no additional cost and make sure the next match is better aligned with what you need.',
    },
    {
        question: 'Do I have to manage international payroll for everyone?',
        answer: 'Not at all. We handle all payroll on our end regardless of team size. You pay us for the hours worked across your team and we take care of everything else — no international wire transfers, no compliance headaches, no per-person admin.',
    },
    {
        question: 'How do I know my whole team is actually being productive?',
        answer: 'Every team member uses full-screen tracking software that monitors activity throughout their shift. All activity data is reviewed by our in-house HR team, so you have visibility and accountability across the board without having to micromanage anyone.',
    },
];
