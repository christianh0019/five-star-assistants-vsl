...
const faqs = [
    ...
    {
        question: 'What exactly can a social media manager handle?',
        answer: 'Graphic design for posts, short-form video editing (Reels, TikToks, Shorts), caption writing, hashtag research, content scheduling, comment and DM management, and monthly content calendars — the whole deal.',
    },
    {
        question: 'What tools do they work in?',
        answer: 'Our social media managers are experienced with Canva, CapCut, Adobe Premiere, Buffer, Later, Hootsuite, Meta Business Suite, and more. Just tell us what you use and we\'ll match you accordingly.',
    },
    {
    ...
    {
        question: 'How do I know my manager is actually being productive?',
        answer: 'Every team member uses full-screen tracking software that monitors activity throughout their shift. All activity data is reviewed and managed by our in-house HR team, so you always have visibility without having to micromanage.',
    },
];
            ...
            <ScrollReveal>
                <section className="max-w-[800px] w-full text-center mt-10 mb-10">
                    ...
                    <h1 className="font-heading text-navy text-4xl md:text-6xl font-bold leading-tight mb-6 drop-shadow-sm">
                        Hire A Dedicated Social Media Manager Starting at <span className="text-gold italic">$5/hr</span>
                    </h1>
